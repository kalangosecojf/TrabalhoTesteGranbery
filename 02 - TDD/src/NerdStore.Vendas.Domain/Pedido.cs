...
namespace NerdStore.Vendas.Domain
{
    public class Pedido : Entity, IAggregateRoot
    {
        ...
        public void CalcularValorTotalDesconto()
        {
            ...
            if (Voucher.TipoDescontoVoucher == TipoDescontoVoucher.Porcentagem)//3
            {
                if (Voucher.PercentualDesconto.HasValue)//4
                {
            ...
            {
                if (Voucher.ValorDesconto.HasValue)//6
                {
